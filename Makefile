...
deploy: build
	tar -czf pret-app.tar.gz build meta.json
	viam module upload --version=${VERSION} --platform=any --public-namespace=${ORG_PUBLIC_NAMESPACE} --name=${MODULE_NAME} pret-app.tar.gz
